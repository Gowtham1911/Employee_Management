      ...
      <main className="flex-1 p-8 overflow-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => {
                const csv = "first_name,last_name,email,phone,department,position,salary,hire_date,status\nJohn,Doe,john@company.com,1234567890,Engineering,Developer,60000,2024-01-15,active";
